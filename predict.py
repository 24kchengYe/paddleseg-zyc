...
def parse_args():
    ...
    parser.add_argument(
        "--config", dest="cfg", help="The config file.", default='configs/segformer/segformer_b5_cityscapes_1024x1024_160k.yml', type=str)

    #default = 'configs/road_seg/pp_liteseg_stdc1_deepglobe_1024x1024_80k.yml'
    #default='configs/deeplabv3p/deeplabv3p_resnet50_os8_voc12aug_512x512_40k.yml'
    #default = 'configs/segformer/segformer_b5_cityscapes_1024x1024_160k.yml'
    ...
    parser.add_argument(
        ...
        type=str,
        default='output/model/segformer_b5_cityscapes_1024x1024_160k/best_model/model.pdparams')

    #default='output/model/pp_liteseg_stdc1_deepglobe/iter_10000/model.pdparams'
    #default = 'output/model/deeplabv3p_resnet50_os8_voc12aug_512x512_40k'
    #default='output/model/segformer_b5_cityscapes_1024x1024_160k/iter_1000/model.pdparams'
    ...
    parser.add_argument(
        ...
        type=str,
        default='data/deepglobe/test.txt')
    parser.add_argument(
        '--save_dir',
        dest='save_dir',
        help='The directory for saving the predicted results',
        type=str,
        default='output/predict/segformer_b5_cityscapes_1024x1024_160k/pred_test')

    #default='output/predict/pp_liteseg_stdc1_deepglobe_1024x1024_80k/pred_test'
    #default='output/predict/deeplabv3p_resnet50_os8_voc12aug_512x512_40k/pred_test'
    #default='output/predict/segformer_b5_cityscapes_1024x1024_160k/pred_test'
