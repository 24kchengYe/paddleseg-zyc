...
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3'  # 0:显示所有日志信息（默认）, 1:显示 warning 和 Error 信息, 2:显示 Error 信息, 3:仅显示 Error 信息


# ...
# 在这之后继续进行您的TensorFlow代码操作
import argparse
import random
...
os.environ['PADDLE_ENABLE_LOGGING'] = '0'  # 禁用PaddlePaddle的日志输出
import logging
logging.getLogger().setLevel(logging.CRITICAL)
# ...
# 在这之后继续进行您的PaddlePaddle代码操作
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='output/model/segformer_b5_cityscapes_1024x1024_160k')

    #default='output/model/pp_liteseg_stdc1_deepglobe_1024x1024_80k'
